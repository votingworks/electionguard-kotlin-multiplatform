...
class RunDecryptionJsonTest {
    ...
    fun testDecryptionAll() {
        val inputDir = "/home/snake/dev/github/electionguard-kotlin-multiplatform/src/commonTest/data/runWorkflowAllAvailable"
    ...
    fun testDecryptionSome() {
        val inputDir = "/home/snake/dev/github/electionguard-kotlin-multiplatform/src/commonTest/data/runWorkflowSomeAvailable"
        val trusteeDir = "$inputDir/private_data/trustees"
        main(
            arrayOf(
                "-in",
