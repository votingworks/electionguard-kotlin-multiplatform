...
class ModPowTabB(bases: List<BigInteger>, offset: Int, val width: Int, val modulus: BigInteger, val show: Boolean = false) {
...
fun modPowProdB(
    ...
    val maxWidth = 7 // this is the window, doing this many bits at a time (out of 256)
    ...
    while (offset < end) {
        ...
        // Compute table for simultaneous exponentiation. that is, 7 at a time.
        val tab = ModPowTabB(bases, offset, width, modulus)
