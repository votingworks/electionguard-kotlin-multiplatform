 ...
 * (2) NIST (2008) The Keyed-Hash Message Authentication Code (HMAC). In: FIPS 198-1. https://csrc.nist.
 * gov/publications/detail/fips/198/1/final
 * (3) NIST (2015) Secure Hash Standard (SHS). In: FIPS 180-4. https://csrc.nist.gov/publications/detail/
 * fips/180/4/final
 *
 * spec 1.9 p.8.
 */
