...
public data class Manifest(
    ...
    val electionType: electionguard.protogen.Manifest.ElectionType = electionguard.protogen.Manifest.ElectionType.fromValue(0),
    ...
    override val descriptor: pbandk.MessageDescriptor<electionguard.protogen.Manifest> get() = Companion.descriptor
    override val protoSize: Int by lazy { super.protoSize }
    public companion object : pbandk.Message.Companion<electionguard.protogen.Manifest> {
        public val defaultInstance: electionguard.protogen.Manifest by lazy { electionguard.protogen.Manifest() }
            ...
            fieldsList.apply {
                ...
                add(
                    pbandk.FieldDescriptor(
                        ...
                        name = "election_type",
                        number = 3,
                        type = pbandk.FieldDescriptor.Type.Enum(enumCompanion = electionguard.protogen.Manifest.ElectionType.Companion),
                ...
                add(
                    pbandk.FieldDescriptor(
                        ...
                        number = 6,
                        type = pbandk.FieldDescriptor.Type.Repeated<electionguard.protogen.GeopoliticalUnit>(valueType = pbandk.FieldDescriptor.Type.Message(messageCompanion = electionguard.protogen.GeopoliticalUnit.Companion)),
                ...
                add(
                    pbandk.FieldDescriptor(
                        ...
                        name = "parties",
                        number = 7,
                        type = pbandk.FieldDescriptor.Type.Repeated<electionguard.protogen.Party>(valueType = pbandk.FieldDescriptor.Type.Message(messageCompanion = electionguard.protogen.Party.Companion)),
                        jsonName = "parties",
                ...
                add(
                    pbandk.FieldDescriptor(
                        ...
                        name = "candidates",
                        number = 8,
                        type = pbandk.FieldDescriptor.Type.Repeated<electionguard.protogen.Candidate>(valueType = pbandk.FieldDescriptor.Type.Message(messageCompanion = electionguard.protogen.Candidate.Companion)),
                        jsonName = "candidates",
                ...
                add(
                    pbandk.FieldDescriptor(
                        ...
                        name = "contests",
                        number = 9,
                        type = pbandk.FieldDescriptor.Type.Repeated<electionguard.protogen.ContestDescription>(valueType = pbandk.FieldDescriptor.Type.Message(messageCompanion = electionguard.protogen.ContestDescription.Companion)),
                        jsonName = "contests",
                ...
                add(
                    pbandk.FieldDescriptor(
                        ...
                        name = "ballot_styles",
                        number = 10,
                        type = pbandk.FieldDescriptor.Type.Repeated<electionguard.protogen.BallotStyle>(valueType = pbandk.FieldDescriptor.Type.Message(messageCompanion = electionguard.protogen.BallotStyle.Companion)),
                ...
                add(
                    pbandk.FieldDescriptor(
                        ...
                        name = "name",
                        number = 11,
                        type = pbandk.FieldDescriptor.Type.Message(messageCompanion = electionguard.protogen.InternationalizedText.Companion),
                        jsonName = "name",
    ...
    public sealed class ElectionType(override val value: Int, override val name: String? = null) : pbandk.Message.Enum {
        ...
        public companion object : pbandk.Message.Enum.Companion<Manifest.ElectionType> {
            public val values: List<Manifest.ElectionType> by lazy { listOf(UNKNOWN, GENERAL, PARTISAN_PRIMARY_CLOSED, PARTISAN_PRIMARY_OPEN, PRIMARY, RUNOFF, SPECIAL) }
...
public data class AnnotatedString(
    ...
    override operator fun plus(other: pbandk.Message?): electionguard.protogen.AnnotatedString = protoMergeImpl(other)
    override val descriptor: pbandk.MessageDescriptor<electionguard.protogen.AnnotatedString> get() = Companion.descriptor
    override val protoSize: Int by lazy { super.protoSize }
    public companion object : pbandk.Message.Companion<electionguard.protogen.AnnotatedString> {
        public val defaultInstance: electionguard.protogen.AnnotatedString by lazy { electionguard.protogen.AnnotatedString() }
        override fun decodeWith(u: pbandk.MessageDecoder): electionguard.protogen.AnnotatedString = electionguard.protogen.AnnotatedString.decodeWithImpl(u)

        override val descriptor: pbandk.MessageDescriptor<electionguard.protogen.AnnotatedString> by lazy {
            val fieldsList = ArrayList<pbandk.FieldDescriptor<electionguard.protogen.AnnotatedString, *>>(2)
            fieldsList.apply {
                add(
                    pbandk.FieldDescriptor(
                        messageDescriptor = this@Companion::descriptor,
...
public data class BallotStyle(
    ...
    override operator fun plus(other: pbandk.Message?): electionguard.protogen.BallotStyle = protoMergeImpl(other)
    override val descriptor: pbandk.MessageDescriptor<electionguard.protogen.BallotStyle> get() = Companion.descriptor
    override val protoSize: Int by lazy { super.protoSize }
    public companion object : pbandk.Message.Companion<electionguard.protogen.BallotStyle> {
        public val defaultInstance: electionguard.protogen.BallotStyle by lazy { electionguard.protogen.BallotStyle() }
        override fun decodeWith(u: pbandk.MessageDecoder): electionguard.protogen.BallotStyle = electionguard.protogen.BallotStyle.decodeWithImpl(u)

        override val descriptor: pbandk.MessageDescriptor<electionguard.protogen.BallotStyle> by lazy {
            val fieldsList = ArrayList<pbandk.FieldDescriptor<electionguard.protogen.BallotStyle, *>>(4)
            fieldsList.apply {
                add(
                    pbandk.FieldDescriptor(
                        messageDescriptor = this@Companion::descriptor,
...
public data class Candidate(
    ...
    override operator fun plus(other: pbandk.Message?): electionguard.protogen.Candidate = protoMergeImpl(other)
    override val descriptor: pbandk.MessageDescriptor<electionguard.protogen.Candidate> get() = Companion.descriptor
    override val protoSize: Int by lazy { super.protoSize }
    public companion object : pbandk.Message.Companion<electionguard.protogen.Candidate> {
        public val defaultInstance: electionguard.protogen.Candidate by lazy { electionguard.protogen.Candidate() }
        override fun decodeWith(u: pbandk.MessageDecoder): electionguard.protogen.Candidate = electionguard.protogen.Candidate.decodeWithImpl(u)

        override val descriptor: pbandk.MessageDescriptor<electionguard.protogen.Candidate> by lazy {
            val fieldsList = ArrayList<pbandk.FieldDescriptor<electionguard.protogen.Candidate, *>>(5)
            fieldsList.apply {
                add(
                    pbandk.FieldDescriptor(
                        messageDescriptor = this@Companion::descriptor,
...
public data class ContactInformation(
    ...
    override operator fun plus(other: pbandk.Message?): electionguard.protogen.ContactInformation = protoMergeImpl(other)
    override val descriptor: pbandk.MessageDescriptor<electionguard.protogen.ContactInformation> get() = Companion.descriptor
    override val protoSize: Int by lazy { super.protoSize }
    public companion object : pbandk.Message.Companion<electionguard.protogen.ContactInformation> {
        public val defaultInstance: electionguard.protogen.ContactInformation by lazy { electionguard.protogen.ContactInformation() }
        override fun decodeWith(u: pbandk.MessageDecoder): electionguard.protogen.ContactInformation = electionguard.protogen.ContactInformation.decodeWithImpl(u)

        override val descriptor: pbandk.MessageDescriptor<electionguard.protogen.ContactInformation> by lazy {
            val fieldsList = ArrayList<pbandk.FieldDescriptor<electionguard.protogen.ContactInformation, *>>(4)
            fieldsList.apply {
                add(
                    pbandk.FieldDescriptor(
                        messageDescriptor = this@Companion::descriptor,
                ...
                add(
                    pbandk.FieldDescriptor(
                        ...
                        name = "email",
                        number = 3,
                        type = pbandk.FieldDescriptor.Type.Repeated<electionguard.protogen.AnnotatedString>(valueType = pbandk.FieldDescriptor.Type.Message(messageCompanion = electionguard.protogen.AnnotatedString.Companion)),
                        jsonName = "email",
...
public data class GeopoliticalUnit(
    ...
    override operator fun plus(other: pbandk.Message?): electionguard.protogen.GeopoliticalUnit = protoMergeImpl(other)
    override val descriptor: pbandk.MessageDescriptor<electionguard.protogen.GeopoliticalUnit> get() = Companion.descriptor
    override val protoSize: Int by lazy { super.protoSize }
    public companion object : pbandk.Message.Companion<electionguard.protogen.GeopoliticalUnit> {
        public val defaultInstance: electionguard.protogen.GeopoliticalUnit by lazy { electionguard.protogen.GeopoliticalUnit() }
        override fun decodeWith(u: pbandk.MessageDecoder): electionguard.protogen.GeopoliticalUnit = electionguard.protogen.GeopoliticalUnit.decodeWithImpl(u)

        override val descriptor: pbandk.MessageDescriptor<electionguard.protogen.GeopoliticalUnit> by lazy {
            val fieldsList = ArrayList<pbandk.FieldDescriptor<electionguard.protogen.GeopoliticalUnit, *>>(4)
            fieldsList.apply {
                add(
                    pbandk.FieldDescriptor(
                        messageDescriptor = this@Companion::descriptor,
                ...
                add(
                    pbandk.FieldDescriptor(
                        ...
                        name = "type",
                        number = 3,
                        type = pbandk.FieldDescriptor.Type.Enum(enumCompanion = electionguard.protogen.GeopoliticalUnit.ReportingUnitType.Companion),
                        jsonName = "type",
...
public data class InternationalizedText(
    ...
    override operator fun plus(other: pbandk.Message?): electionguard.protogen.InternationalizedText = protoMergeImpl(other)
    override val descriptor: pbandk.MessageDescriptor<electionguard.protogen.InternationalizedText> get() = Companion.descriptor
    override val protoSize: Int by lazy { super.protoSize }
    public companion object : pbandk.Message.Companion<electionguard.protogen.InternationalizedText> {
        public val defaultInstance: electionguard.protogen.InternationalizedText by lazy { electionguard.protogen.InternationalizedText() }
        override fun decodeWith(u: pbandk.MessageDecoder): electionguard.protogen.InternationalizedText = electionguard.protogen.InternationalizedText.decodeWithImpl(u)

        override val descriptor: pbandk.MessageDescriptor<electionguard.protogen.InternationalizedText> by lazy {
            val fieldsList = ArrayList<pbandk.FieldDescriptor<electionguard.protogen.InternationalizedText, *>>(1)
            fieldsList.apply {
                add(
                    pbandk.FieldDescriptor(
                        messageDescriptor = this@Companion::descriptor,
                        name = "text",
                        number = 1,
                        type = pbandk.FieldDescriptor.Type.Repeated<electionguard.protogen.Language>(valueType = pbandk.FieldDescriptor.Type.Message(messageCompanion = electionguard.protogen.Language.Companion)),
                        jsonName = "text",
...
public data class Language(
    ...
    override operator fun plus(other: pbandk.Message?): electionguard.protogen.Language = protoMergeImpl(other)
    override val descriptor: pbandk.MessageDescriptor<electionguard.protogen.Language> get() = Companion.descriptor
    override val protoSize: Int by lazy { super.protoSize }
    public companion object : pbandk.Message.Companion<electionguard.protogen.Language> {
        public val defaultInstance: electionguard.protogen.Language by lazy { electionguard.protogen.Language() }
        override fun decodeWith(u: pbandk.MessageDecoder): electionguard.protogen.Language = electionguard.protogen.Language.decodeWithImpl(u)

        override val descriptor: pbandk.MessageDescriptor<electionguard.protogen.Language> by lazy {
            val fieldsList = ArrayList<pbandk.FieldDescriptor<electionguard.protogen.Language, *>>(2)
            fieldsList.apply {
                add(
                    pbandk.FieldDescriptor(
                        messageDescriptor = this@Companion::descriptor,
...
public data class Party(
    ...
    override operator fun plus(other: pbandk.Message?): electionguard.protogen.Party = protoMergeImpl(other)
    override val descriptor: pbandk.MessageDescriptor<electionguard.protogen.Party> get() = Companion.descriptor
    override val protoSize: Int by lazy { super.protoSize }
    public companion object : pbandk.Message.Companion<electionguard.protogen.Party> {
        public val defaultInstance: electionguard.protogen.Party by lazy { electionguard.protogen.Party() }
        override fun decodeWith(u: pbandk.MessageDecoder): electionguard.protogen.Party = electionguard.protogen.Party.decodeWithImpl(u)

        override val descriptor: pbandk.MessageDescriptor<electionguard.protogen.Party> by lazy {
            val fieldsList = ArrayList<pbandk.FieldDescriptor<electionguard.protogen.Party, *>>(5)
            fieldsList.apply {
                add(
                    pbandk.FieldDescriptor(
                        messageDescriptor = this@Companion::descriptor,
...
public data class ContestDescription(
    ...
    override val descriptor: pbandk.MessageDescriptor<electionguard.protogen.ContestDescription> get() = Companion.descriptor
    override val protoSize: Int by lazy { super.protoSize }
    public companion object : pbandk.Message.Companion<electionguard.protogen.ContestDescription> {
        public val defaultInstance: electionguard.protogen.ContestDescription by lazy { electionguard.protogen.ContestDescription() }
            ...
            fieldsList.apply {
                ...
                add(
                    pbandk.FieldDescriptor(
                        ...
                        name = "vote_variation",
                        number = 4,
                        type = pbandk.FieldDescriptor.Type.Enum(enumCompanion = electionguard.protogen.ContestDescription.VoteVariationType.Companion),
...
public data class SelectionDescription(
    ...
    override val descriptor: pbandk.MessageDescriptor<electionguard.protogen.SelectionDescription> get() = Companion.descriptor
    override val protoSize: Int by lazy { super.protoSize }
    public companion object : pbandk.Message.Companion<electionguard.protogen.SelectionDescription> {
        public val defaultInstance: electionguard.protogen.SelectionDescription by lazy { electionguard.protogen.SelectionDescription() }
...
private fun Manifest.Companion.decodeWithImpl(u: pbandk.MessageDecoder): Manifest {
    var electionScopeId = ""
    var specVersion = ""
    var electionType: electionguard.protogen.Manifest.ElectionType = electionguard.protogen.Manifest.ElectionType.fromValue(0)
    var startDate = ""
    var endDate = ""
    var geopoliticalUnits: pbandk.ListWithSize.Builder<electionguard.protogen.GeopoliticalUnit>? = null
...
public fun AnnotatedString?.orDefault(): electionguard.protogen.AnnotatedString = this ?: AnnotatedString.defaultInstance

private fun AnnotatedString.protoMergeImpl(plus: pbandk.Message?): AnnotatedString = (plus as? AnnotatedString)?.let {
    it.copy(
        unknownFields = unknownFields + plus.unknownFields
    )
} ?: this
...
public fun BallotStyle?.orDefault(): electionguard.protogen.BallotStyle = this ?: BallotStyle.defaultInstance
...
public fun Candidate?.orDefault(): electionguard.protogen.Candidate = this ?: Candidate.defaultInstance
...
public fun ContactInformation?.orDefault(): electionguard.protogen.ContactInformation = this ?: ContactInformation.defaultInstance
...
private fun ContactInformation.Companion.decodeWithImpl(u: pbandk.MessageDecoder): ContactInformation {
    ...
    val unknownFields = u.readMessage(this) { _fieldNumber, _fieldValue ->
        when (_fieldNumber) {
            ...
            3 -> email = (email ?: pbandk.ListWithSize.Builder()).apply { this += _fieldValue as Sequence<electionguard.protogen.AnnotatedString> }
            4 -> phone = (phone ?: pbandk.ListWithSize.Builder()).apply { this += _fieldValue as Sequence<electionguard.protogen.AnnotatedString> }
        }
    }
    return ContactInformation(name, pbandk.ListWithSize.Builder.fixed(addressLine), pbandk.ListWithSize.Builder.fixed(email), pbandk.ListWithSize.Builder.fixed(phone), unknownFields)
}

@pbandk.Export
@pbandk.JsName("orDefaultForGeopoliticalUnit")
public fun GeopoliticalUnit?.orDefault(): electionguard.protogen.GeopoliticalUnit = this ?: GeopoliticalUnit.defaultInstance
...
public fun InternationalizedText?.orDefault(): electionguard.protogen.InternationalizedText = this ?: InternationalizedText.defaultInstance

private fun InternationalizedText.protoMergeImpl(plus: pbandk.Message?): InternationalizedText = (plus as? InternationalizedText)?.let {
    it.copy(
        text = text + plus.text,
        unknownFields = unknownFields + plus.unknownFields
    )
...
@Suppress("UNCHECKED_CAST")
private fun InternationalizedText.Companion.decodeWithImpl(u: pbandk.MessageDecoder): InternationalizedText {
    var text: pbandk.ListWithSize.Builder<electionguard.protogen.Language>? = null

    val unknownFields = u.readMessage(this) { _fieldNumber, _fieldValue ->
        when (_fieldNumber) {
            1 -> text = (text ?: pbandk.ListWithSize.Builder()).apply { this += _fieldValue as Sequence<electionguard.protogen.Language> }
        }
    }
...
public fun ContestDescription?.orDefault(): electionguard.protogen.ContestDescription = this ?: ContestDescription.defaultInstance
...
public fun SelectionDescription?.orDefault(): electionguard.protogen.SelectionDescription = this ?: SelectionDescription.defaultInstance
