...
data class SubmittedBallotConvert(val groupContext: GroupContext) {
    ...
    private fun convertBallotState(
        proto: electionguard.protogen.SubmittedBallot.BallotState?
    ...
    private fun convertContest(
        proto: electionguard.protogen.CiphertextBallotContest?
    ...
    private fun convertSelection(
        proto: electionguard.protogen.CiphertextBallotSelection?
    ...
    fun convertConstantChaumPedersenProof(
        proof: electionguard.protogen.ConstantChaumPedersenProof?
    ...
    fun convertDisjunctiveChaumPedersenProof(
        proof: electionguard.protogen.DisjunctiveChaumPedersenProof?
    ...
    private fun convertBallotState(
        type: SubmittedBallot.BallotState
    ...
    private fun convertContest(
        contest: SubmittedBallot.Contest
        ...
        return electionguard.protogen
            .CiphertextBallotContest(
                ...
                if (contest.proof == null) { null } else {
                    convertConstantChaumPedersenProof(contest.proof)
                },
            )
    }

    private fun convertSelection(
        selection: SubmittedBallot.Selection
        ...
        return electionguard.protogen
            .CiphertextBallotSelection(
                ...
                if (selection.proof == null) { null } else {
                    convertDisjunctiveChaumPedersenProof(selection.proof)
                },
                if (selection.extendedData == null) { null } else {
                    convertCiphertext(selection.extendedData)
                },
            )
    }

    fun convertConstantChaumPedersenProof(
        proof: ConstantChaumPedersenProofKnownNonce
    ...
    fun convertDisjunctiveChaumPedersenProof(
        proof: DisjunctiveChaumPedersenProofKnownNonce
