...
/**
 * Construct a DLog implementation for the given `base` element. This might be the group's generator,
 * or it might be any other value in consideration.
 */
...
expect class DLog {
    ...
    /**
     * Given an an element x for which there exists an e, such that (base)^e = x, this will find e, so
