...
internal fun ExpandedGenericChaumPedersenProof.isValid(
    ...
    val hashGood =
        !checkC || c == hashElements(*hashHeader, a, b, *hashFooter).toElementModQ(context)
 ...
 *     hash.
 * @param hashFooter Optional additional values to include in the end of the challenge computation
 *     hash.
 */
