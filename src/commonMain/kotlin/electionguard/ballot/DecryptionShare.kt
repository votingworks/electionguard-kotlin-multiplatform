...
class DecryptionShare {
     ...
     * generated by a guardian directly, or it can be compensated for by a quorum of guardians <p>
     * When the guardian generates this share directly, the `proof` field is populated with a
     * `chaumPedersen` proof that the decryption share was generated correctly. <p> When the share
     * is generated on behalf of this guardian by other guardians, the `recovered_parts` collection
     * is populated with the `CiphertextCompensatedDecryptionSelection` objects generated by each
     * available guardian.
     *
