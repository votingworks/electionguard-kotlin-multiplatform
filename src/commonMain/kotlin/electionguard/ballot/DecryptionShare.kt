...
class DecryptionShare {
     ...
     * generated by a guardian directly, or it can be compensated for by a quorum of guardians.
     * When the guardian generates this share directly, the `proof` field is populated with a
     * `chaumPedersen` proof that the decryption share was generated correctly. When the share
