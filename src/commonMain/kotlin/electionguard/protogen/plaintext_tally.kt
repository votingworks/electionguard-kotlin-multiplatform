...
public data class CiphertextDecryptionSelection(
    ...
    public sealed class ProofOrParts<V>(value: V) : pbandk.Message.OneOf<V>(value) {
        public class Proof(proof: electionguard.protogen.ChaumPedersenProof) :
            ProofOrParts<electionguard.protogen.ChaumPedersenProof>(proof)
                        ...
                        pbandk.FieldDescriptor(
                            ...
                            type =
                                pbandk.FieldDescriptor
                                    ...
                                    .Message(
                                        messageCompanion =
                                            electionguard.protogen.ChaumPedersenProof.Companion
                                    ),
                            oneofMember = true,
                            jsonName = "proof",
        ...
        u.readMessage(this) { _fieldNumber, _fieldValue ->
            when (_fieldNumber) {
                ...
                4 ->
                    proofOrParts =
                        CiphertextDecryptionSelection.ProofOrParts
                            .Proof(_fieldValue as electionguard.protogen.ChaumPedersenProof)
                5 ->
                    proofOrParts =
                        CiphertextDecryptionSelection.ProofOrParts
