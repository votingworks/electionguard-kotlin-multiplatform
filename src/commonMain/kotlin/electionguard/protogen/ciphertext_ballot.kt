        ...
        ?.let {
            it.copy(
                ...
                previousTrackingHash =
                    previousTrackingHash?.plus(plus.previousTrackingHash)
                        ?: plus.previousTrackingHash,
    ...
    val unknownFields =
        u.readMessage(this) { _fieldNumber, _fieldValue ->
            when (_fieldNumber) {
                ...
                4 -> previousTrackingHash = _fieldValue as electionguard.protogen.ElementModQ
                5 -> trackingHash = _fieldValue as electionguard.protogen.ElementModQ
                6 ->
                    contests =
