...
public data class SubmittedBallot(
    ...
    val codeSeed: electionguard.protogen.ElementModQ? = null,
    val code: electionguard.protogen.ElementModQ? = null,
    ...
    val state: electionguard.protogen.SubmittedBallot.BallotState =
        electionguard.protogen.SubmittedBallot.BallotState.fromValue(0),
    override val unknownFields: Map<Int, pbandk.UnknownField> = emptyMap()
) : pbandk.Message {
    override operator fun plus(other: pbandk.Message?): electionguard.protogen.SubmittedBallot =
        protoMergeImpl(other)
    override val descriptor: pbandk.MessageDescriptor<electionguard.protogen.SubmittedBallot>
    ...
    public companion object : pbandk.Message.Companion<electionguard.protogen.SubmittedBallot> {
        public val defaultInstance: electionguard.protogen.SubmittedBallot by
            lazy { electionguard.protogen.SubmittedBallot() }
        override fun decodeWith(u: pbandk.MessageDecoder): electionguard.protogen.SubmittedBallot =
            electionguard.protogen.SubmittedBallot.decodeWithImpl(u)

        override val descriptor: pbandk.MessageDescriptor<electionguard.protogen.SubmittedBallot> by
            lazy {
                val fieldsList =
                    ArrayList<pbandk.FieldDescriptor<electionguard.protogen.SubmittedBallot, *>>(9)
                fieldsList.apply {
                    add(
                    ...
                    add(
                        pbandk.FieldDescriptor(
                            ...
                            type =
                                pbandk.FieldDescriptor
                                    .Type
                                    .Repeated<electionguard.protogen.CiphertextBallotContest>(
                                        valueType =
                                            pbandk.FieldDescriptor
                                                .Type
                                                .Message(
    ...
    public sealed class BallotState(override val value: Int, override val name: String? = null) :
        pbandk.Message.Enum {

        override fun equals(other: kotlin.Any?): Boolean =
            other is SubmittedBallot.BallotState && other.value == value
        override fun hashCode(): Int = value.hashCode()
        override fun toString(): String =
            "SubmittedBallot.BallotState.${name ?: "UNRECOGNIZED"}(value=$value)"
        ...
        public companion object : pbandk.Message.Enum.Companion<SubmittedBallot.BallotState> {
            public val values: List<SubmittedBallot.BallotState> by
                lazy { listOf(UNKNOWN, CAST, SPOILED) }
            override fun fromValue(value: Int): SubmittedBallot.BallotState =
                values.firstOrNull { it.value == value } ?: UNRECOGNIZED(value)
            override fun fromName(name: String): SubmittedBallot.BallotState =
                values.firstOrNull { it.name == name }
                    ?: throw IllegalArgumentException("No BallotState with name: $name")
        }
    }
}
...
public data class CiphertextBallotContest(
    ...
    val contestHash: electionguard.protogen.ElementModQ? = null,
    ...
    ): electionguard.protogen.CiphertextBallotContest = protoMergeImpl(other)
    override val descriptor:
        pbandk.MessageDescriptor<electionguard.protogen.CiphertextBallotContest>
        get() = Companion.descriptor
    override val protoSize: Int by lazy { super.protoSize }
    public companion object :
        pbandk.Message.Companion<electionguard.protogen.CiphertextBallotContest> {

        public val defaultInstance: electionguard.protogen.CiphertextBallotContest by
            lazy { electionguard.protogen.CiphertextBallotContest() }
        override fun decodeWith(
            u: pbandk.MessageDecoder
        ): electionguard.protogen.CiphertextBallotContest =
            electionguard.protogen.CiphertextBallotContest.decodeWithImpl(u)

        override val descriptor:
            pbandk.MessageDescriptor<electionguard.protogen.CiphertextBallotContest> by
            lazy {
                val fieldsList =
                    ArrayList<
                        pbandk.FieldDescriptor<electionguard.protogen.CiphertextBallotContest, *>
                    >(7)
                fieldsList.apply {
                    add(
                        pbandk.FieldDescriptor(
                    ...
                    add(
                        pbandk.FieldDescriptor(
                            ...
                            type =
                                pbandk.FieldDescriptor
                                    .Type
                                    .Repeated<electionguard.protogen.CiphertextBallotSelection>(
                                        valueType =
                                            pbandk.FieldDescriptor
                                                .Type
                                                .Message(
                    ...
                    add(
                        pbandk.FieldDescriptor(
                            ...
                            value =
                                electionguard.protogen
                                    .CiphertextBallotContest::ciphertextAccumulation
                        )
                    )
                    add(
                        pbandk.FieldDescriptor(
...
public data class CiphertextBallotSelection(
    ...
    val sequenceOrder: Int = 0,
    val selectionHash: electionguard.protogen.ElementModQ? = null,
    ...
    override operator fun plus(
        other: pbandk.Message?
    ): electionguard.protogen.CiphertextBallotSelection = protoMergeImpl(other)
    override val descriptor:
        pbandk.MessageDescriptor<electionguard.protogen.CiphertextBallotSelection>
        get() = Companion.descriptor
    override val protoSize: Int by lazy { super.protoSize }
    public companion object :
        pbandk.Message.Companion<electionguard.protogen.CiphertextBallotSelection> {

        public val defaultInstance: electionguard.protogen.CiphertextBallotSelection by
            lazy { electionguard.protogen.CiphertextBallotSelection() }
        override fun decodeWith(
            u: pbandk.MessageDecoder
        ): electionguard.protogen.CiphertextBallotSelection =
            electionguard.protogen.CiphertextBallotSelection.decodeWithImpl(u)

        override val descriptor:
            pbandk.MessageDescriptor<electionguard.protogen.CiphertextBallotSelection> by
            lazy {
                val fieldsList =
                    ArrayList<
                        pbandk.FieldDescriptor<electionguard.protogen.CiphertextBallotSelection, *>
                    >(8)
                fieldsList.apply {
                    add(
                        pbandk.FieldDescriptor(
                    ...
                    add(
                        pbandk.FieldDescriptor(
                            ...
                            value =
                                electionguard.protogen
                                    .CiphertextBallotSelection::isPlaceholderSelection
                        )
                    )
                    add(
                        pbandk.FieldDescriptor(
...
public data class ConstantChaumPedersenProof(
    ...
    override operator fun plus(
        other: pbandk.Message?
    ): electionguard.protogen.ConstantChaumPedersenProof = protoMergeImpl(other)
    override val descriptor:
        pbandk.MessageDescriptor<electionguard.protogen.ConstantChaumPedersenProof>
        get() = Companion.descriptor
    override val protoSize: Int by lazy { super.protoSize }
    public companion object :
        pbandk.Message.Companion<electionguard.protogen.ConstantChaumPedersenProof> {

        public val defaultInstance: electionguard.protogen.ConstantChaumPedersenProof by
            lazy { electionguard.protogen.ConstantChaumPedersenProof() }
        override fun decodeWith(
            u: pbandk.MessageDecoder
        ): electionguard.protogen.ConstantChaumPedersenProof =
            electionguard.protogen.ConstantChaumPedersenProof.decodeWithImpl(u)

        override val descriptor:
            pbandk.MessageDescriptor<electionguard.protogen.ConstantChaumPedersenProof> by
            lazy {
                val fieldsList =
                    ArrayList<
                        pbandk.FieldDescriptor<electionguard.protogen.ConstantChaumPedersenProof, *>
                    >(5)
                fieldsList.apply {
                    add(
                        pbandk.FieldDescriptor(
...
public data class DisjunctiveChaumPedersenProof(
    ...
    override operator fun plus(
        other: pbandk.Message?
    ): electionguard.protogen.DisjunctiveChaumPedersenProof = protoMergeImpl(other)
    override val descriptor:
        pbandk.MessageDescriptor<electionguard.protogen.DisjunctiveChaumPedersenProof>
        get() = Companion.descriptor
    override val protoSize: Int by lazy { super.protoSize }
    public companion object :
        pbandk.Message.Companion<electionguard.protogen.DisjunctiveChaumPedersenProof> {

        public val defaultInstance: electionguard.protogen.DisjunctiveChaumPedersenProof by
            lazy { electionguard.protogen.DisjunctiveChaumPedersenProof() }
        override fun decodeWith(
            u: pbandk.MessageDecoder
        ): electionguard.protogen.DisjunctiveChaumPedersenProof =
            electionguard.protogen.DisjunctiveChaumPedersenProof.decodeWithImpl(u)

        override val descriptor:
            pbandk.MessageDescriptor<electionguard.protogen.DisjunctiveChaumPedersenProof> by
            lazy {
                val fieldsList =
                    ArrayList<
                        pbandk.FieldDescriptor<
                ...
                fieldsList.apply {
                    add(
                        pbandk.FieldDescriptor(
                            ...
                            value =
                                electionguard.protogen.DisjunctiveChaumPedersenProof::proofZeroPad
                        )
                    )
                    add(
                        pbandk.FieldDescriptor(
                            ...
                            value =
                                electionguard.protogen.DisjunctiveChaumPedersenProof::proofZeroData
                        )
                    )
                    add(
                        pbandk.FieldDescriptor(
                            ...
                            value =
                                electionguard.protogen
                                    .DisjunctiveChaumPedersenProof::proofZeroChallenge
                        )
                    )
                    add(
                        pbandk.FieldDescriptor(
                            ...
                            value =
                                electionguard.protogen
                                    .DisjunctiveChaumPedersenProof::proofZeroResponse
                        )
                    )
                    add(
                        pbandk.FieldDescriptor(
                            ...
                            value =
                                electionguard.protogen.DisjunctiveChaumPedersenProof::proofOnePad
                        )
                    )
                    add(
                        pbandk.FieldDescriptor(
                            ...
                            value =
                                electionguard.protogen.DisjunctiveChaumPedersenProof::proofOneData
                        )
                    )
                    add(
                        pbandk.FieldDescriptor(
                            ...
                            value =
                                electionguard.protogen
                                    .DisjunctiveChaumPedersenProof::proofOneChallenge
                        )
                    )
                    add(
                        pbandk.FieldDescriptor(
                            ...
                            value =
                                electionguard.protogen
                                    .DisjunctiveChaumPedersenProof::proofOneResponse
                        )
                    )
                    add(
                        pbandk.FieldDescriptor(
...
public fun SubmittedBallot?.orDefault(): electionguard.protogen.SubmittedBallot =
    this ?: SubmittedBallot.defaultInstance

private fun SubmittedBallot.protoMergeImpl(plus: pbandk.Message?): SubmittedBallot =
    (plus as? SubmittedBallot)
        ?.let {
            it.copy(
...
private fun SubmittedBallot.Companion.decodeWithImpl(u: pbandk.MessageDecoder): SubmittedBallot {
    ...
    var codeSeed: electionguard.protogen.ElementModQ? = null
    var code: electionguard.protogen.ElementModQ? = null
    var contests: pbandk.ListWithSize.Builder<electionguard.protogen.CiphertextBallotContest>? =
        null
    var timestamp = 0L
    var cryptoHash: electionguard.protogen.ElementModQ? = null
    var state: electionguard.protogen.SubmittedBallot.BallotState =
        electionguard.protogen.SubmittedBallot.BallotState.fromValue(0)
    ...
    val unknownFields =
        u.readMessage(this) { _fieldNumber, _fieldValue ->
            when (_fieldNumber) {
                ...
                4 -> codeSeed = _fieldValue as electionguard.protogen.ElementModQ
                5 -> code = _fieldValue as electionguard.protogen.ElementModQ
                6 ->
                    contests =
                        (contests ?: pbandk.ListWithSize.Builder())
                            .apply {
                                this +=
                                    _fieldValue as
                                        Sequence<electionguard.protogen.CiphertextBallotContest>
                            }
...
public fun CiphertextBallotContest?.orDefault(): electionguard.protogen.CiphertextBallotContest =
    this ?: CiphertextBallotContest.defaultInstance

private fun CiphertextBallotContest.protoMergeImpl(plus: pbandk.Message?): CiphertextBallotContest =
    (plus as? CiphertextBallotContest)
        ?.let {
            it.copy(
                contestHash = contestHash?.plus(plus.contestHash) ?: plus.contestHash,
                selections = selections + plus.selections,
                ciphertextAccumulation =
                    ciphertextAccumulation?.plus(plus.ciphertextAccumulation)
                        ?: plus.ciphertextAccumulation,
                cryptoHash = cryptoHash?.plus(plus.cryptoHash) ?: plus.cryptoHash,
...
@Suppress("UNCHECKED_CAST")
private fun CiphertextBallotContest.Companion.decodeWithImpl(
    u: pbandk.MessageDecoder
): CiphertextBallotContest {
    var contestId = ""
    var sequenceOrder = 0
    var contestHash: electionguard.protogen.ElementModQ? = null
    var selections: pbandk.ListWithSize.Builder<electionguard.protogen.CiphertextBallotSelection>? =
        null
    ...
    val unknownFields =
        u.readMessage(this) { _fieldNumber, _fieldValue ->
            when (_fieldNumber) {
                ...
                3 -> contestHash = _fieldValue as electionguard.protogen.ElementModQ
                4 ->
                    selections =
                        (selections ?: pbandk.ListWithSize.Builder())
                            .apply {
                                this +=
                                    _fieldValue as
                                        Sequence<electionguard.protogen.CiphertextBallotSelection>
                            }
                5 ->
                    ciphertextAccumulation = _fieldValue as electionguard.protogen.ElGamalCiphertext
                6 -> cryptoHash = _fieldValue as electionguard.protogen.ElementModQ
...
public fun CiphertextBallotSelection?.orDefault():
    electionguard.protogen.CiphertextBallotSelection =
        this ?: CiphertextBallotSelection.defaultInstance

private fun CiphertextBallotSelection.protoMergeImpl(
    plus: pbandk.Message?
): CiphertextBallotSelection =
    (plus as? CiphertextBallotSelection)
        ?.let {
            it.copy(
...
@Suppress("UNCHECKED_CAST")
private fun CiphertextBallotSelection.Companion.decodeWithImpl(
    u: pbandk.MessageDecoder
): CiphertextBallotSelection {
    var selectionId = ""
    var sequenceOrder = 0
    var selectionHash: electionguard.protogen.ElementModQ? = null
    ...
    val unknownFields =
        u.readMessage(this) { _fieldNumber, _fieldValue ->
            when (_fieldNumber) {
                ...
                2 -> sequenceOrder = _fieldValue as Int
                3 -> selectionHash = _fieldValue as electionguard.protogen.ElementModQ
...
public fun ConstantChaumPedersenProof?.orDefault():
    electionguard.protogen.ConstantChaumPedersenProof =
        this ?: ConstantChaumPedersenProof.defaultInstance

private fun ConstantChaumPedersenProof.protoMergeImpl(
    plus: pbandk.Message?
): ConstantChaumPedersenProof =
    (plus as? ConstantChaumPedersenProof)
        ?.let {
            it.copy(
...
@Suppress("UNCHECKED_CAST")
private fun ConstantChaumPedersenProof.Companion.decodeWithImpl(
    u: pbandk.MessageDecoder
): ConstantChaumPedersenProof {
    ...
    return ConstantChaumPedersenProof(pad, data, challenge, response, constant, unknownFields)
}

@pbandk.Export
@pbandk.JsName("orDefaultForDisjunctiveChaumPedersenProof")
public fun DisjunctiveChaumPedersenProof?.orDefault():
    electionguard.protogen.DisjunctiveChaumPedersenProof =
        this ?: DisjunctiveChaumPedersenProof.defaultInstance

private fun DisjunctiveChaumPedersenProof.protoMergeImpl(
    plus: pbandk.Message?
): DisjunctiveChaumPedersenProof =
    (plus as? DisjunctiveChaumPedersenProof)
        ?.let {
            it.copy(
                ...
                proofZeroChallenge =
                    proofZeroChallenge?.plus(plus.proofZeroChallenge) ?: plus.proofZeroChallenge,
                proofZeroResponse =
                    proofZeroResponse?.plus(plus.proofZeroResponse) ?: plus.proofZeroResponse,
                ...
                proofOneChallenge =
                    proofOneChallenge?.plus(plus.proofOneChallenge) ?: plus.proofOneChallenge,
                proofOneResponse =
                    proofOneResponse?.plus(plus.proofOneResponse) ?: plus.proofOneResponse,
                challenge = challenge?.plus(plus.challenge) ?: plus.challenge,
                unknownFields = unknownFields + plus.unknownFields
            )
        } ?: this
...
@Suppress("UNCHECKED_CAST")
private fun DisjunctiveChaumPedersenProof.Companion.decodeWithImpl(
    u: pbandk.MessageDecoder
): DisjunctiveChaumPedersenProof {
