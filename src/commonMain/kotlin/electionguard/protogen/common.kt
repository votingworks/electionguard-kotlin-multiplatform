...
public data class ChaumPedersenProof(
    ...
    override operator fun plus(other: pbandk.Message?): electionguard.protogen.ChaumPedersenProof =
        protoMergeImpl(other)
    override val descriptor: pbandk.MessageDescriptor<electionguard.protogen.ChaumPedersenProof>
    ...
    public companion object : pbandk.Message.Companion<electionguard.protogen.ChaumPedersenProof> {
        public val defaultInstance: electionguard.protogen.ChaumPedersenProof by
            lazy { electionguard.protogen.ChaumPedersenProof() }
        override fun decodeWith(
            u: pbandk.MessageDecoder
        ): electionguard.protogen.ChaumPedersenProof =
            electionguard.protogen.ChaumPedersenProof.decodeWithImpl(u)

        override val descriptor: pbandk.MessageDescriptor<electionguard.protogen.ChaumPedersenProof>
            by
            lazy {
                val fieldsList =
                    ArrayList<pbandk.FieldDescriptor<electionguard.protogen.ChaumPedersenProof, *>>(
                        4
                    )
                fieldsList.apply {
                    add(
...
public fun ChaumPedersenProof?.orDefault(): electionguard.protogen.ChaumPedersenProof =
    this ?: ChaumPedersenProof.defaultInstance

private fun ChaumPedersenProof.protoMergeImpl(plus: pbandk.Message?): ChaumPedersenProof =
    (plus as? ChaumPedersenProof)
        ?.let {
            it.copy(
...
private fun ChaumPedersenProof.Companion.decodeWithImpl(
    u: pbandk.MessageDecoder
): ChaumPedersenProof {
