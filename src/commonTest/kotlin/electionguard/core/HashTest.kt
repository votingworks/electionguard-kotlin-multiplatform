...
class HashTest {
    ...
    fun testNonce() {
        runTest {
            ...
            val contestDescriptionHashQ =
                "00C49A1E8053FBA95F6B7CD3F3B30B101CDD595C435A46AECF2872F47F1C601206".fromSafeHex()
                    .toUInt256()
                    .toElementModQ(group)
            println(
                " contestDescriptionHashQ = $contestDescriptionHashQ hex = " +
                    "${contestDescriptionHashQ.cryptoHashString()}"
            )
            val ballotNonce =
                "13E7A2F4253E6CCE42ED5576CF7B01A06BE07835227E7AFE5F538FB94E9A9B73".fromSafeHex()
                    .toUInt256()
                    .toElementModQ(group)
            ...
            val expect =
                "9AD1E8A7127EFFB627C4A8E65818C846BD3FB854B384910098E85E1F6BAF4D2B".fromSafeHex()
                    .toUInt256()
                    .toElementModQ(group)
        ...
        runTest {
            ...
            val s1q =
                "C49A1E8053FBA95F6B7CD3F3B30B101CDD595C435A46AECF2872F47F1C601206".fromSafeHex()
                    ...
                    .toElementModQ(group)
            val s2q =
                "000C49A1E8053FBA95F6B7CD3F3B30B101CDD595C435A46AECF2872F47F1C601206".fromSafeHex()
                    .toUInt256()
                    .toElementModQ(group)
    ...
    fun testElementModQToHex() {
        runTest {
            ...
            println(
                " len = ${subject.cryptoHashString().length} hex = '${subject.cryptoHashString()}'"
            )
    ...
    fun testIterable() {
        runTest {
            ...
            val expect1 =
                "FA059A112CDC05E6554073659B6B3D67E7C4678BDFAE7E69D66ECB7AE3344F53".fromSafeHex()
                    .toUInt256()
            assertEquals(expect1, h1)

            val expect2 =
                "E90FF27925C3CCF7A024BAD4B7406A6F2F0A86EB11273CDA35DECE815B5B382F".fromSafeHex()
                    .toUInt256()
